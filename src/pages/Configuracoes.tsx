...
import {
  Building, Users, Stethoscope, CreditCard, MessageSquare, Webhook, Loader2,
  ClipboardList, GitBranch // Ícone para Funis
} from "lucide-react";
...
// Importar os componentes de procedimentos e funis
const ProcedimentosSettings = React.lazy(() => import('@/components/configuracoes/ProcedimentosSettings'));
const FunnelSettings = React.lazy(() => import('@/components/configuracoes/FunnelSettings'));
      ...
      <div className="container mx-auto py-6 space-y-6">
        ...
        <Tabs defaultValue="whatsapp_api" className="space-y-4">
          ...
          <TabsList className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:flex lg:flex-wrap h-auto justify-start">
            ...
            <TabsTrigger value="funis" className="flex items-center gap-2"><GitBranch className="h-4 w-4" /><span>Funis</span></TabsTrigger>
